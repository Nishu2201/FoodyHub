...
export default function TopHeading() {
  return (
    ...
    <div className='py-6 flex flex-col items-center gap-6'>
         <h1 className='font-semibold font-[font-serif] text-5xl text-[#84563c]'>Choose Best<span className='text-[#412124]'> Services</span></h1>
        ...
        <hr className='sm:w-14 w-40  border-[#84563c] border-2 '/>
    </div>
    </div>
  )
}
