  ...
  return (
    <motion.div variants={variants}  className=" group relative flex flex-col items-center justify-center">
          <div className="relative w-[300px] h-24 ">
            <div className="absolute right-12 bg-black p-3 rounded-[40%6px] z-10 group-hover:bg-[#cdaa88]">
            <ShoppingCartIcon className="w-5 text-white group-hover:text-[#412124] group-hover:animate-bounce"/>
            </div>
        ...
        <div className="p-8 w-[12rem] bg-gradient-to-tr from-black/10 to-slate-200/20 backdrop-blur-sm border border-slate-200/70 -z-10 shadow-lg rounded-[22px]">
          <div className="flex flex-col items-center mt-4">
            <h1 className="font-bold tracking-widest text-[#015228] text-lg">{name}</h1>
            <p className="text-sm text-gray-700/80">{des}</p>
             <h3 className="mt-6 font-[700] text-sm tracking-widest text-center">₹{price}</h3>
          </div>
        </div>
    </motion.div>
  );
